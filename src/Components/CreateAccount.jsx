      ...
      <div className="w-full max-w-sm">
        ...
        hover:-translate-y-1">
          ...
          <form onSubmit={(e) => { e.preventDefault(); handleSignup(); }} className="space-y-3">
            ...
            {/* BUTTON */}
            <button type="submit" className="w-full bg-gradient-to-r from-orange-500 to-pink-500 text-white py-3 rounded-xl font-bold text-sm hover:brightness-110 transition-all active:scale-[0.98] shadow-lg shadow-orange-200 mt-1 group">
              Create Account
            ...
            {/* GOOGLE LOGIN */}
            <button onClick={handleGoogleSignup} type="button" className="w-full bg-white border border-slate-200 text-slate-700 py-2.5 rounded-xl font-bold text-sm hover:bg-slate-50 transition-all flex items-center justify-center gap-2.5">
              <img
